...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (emailOrPhone && password) {
      ...
      localStorage.setItem('userType', emailOrPhone.includes('business') ? 'business' : 'personal')
      localStorage.setItem('userEmail', emailOrPhone)
      router.push('/dashboard?type=' + (emailOrPhone.includes('business') ? 'business' : 'personal'))
    } else {
